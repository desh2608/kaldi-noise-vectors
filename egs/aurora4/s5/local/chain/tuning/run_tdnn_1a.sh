...
# Baseline TDNN-F recipe (optionally including CMN)
...
for f in $train_data_dir/feats.scp $lores_train_data_dir/feats.scp \
    $gmm_dir/final.mdl $ali_dir/ali.1.gz $gmm_dir/final.mdl; do
